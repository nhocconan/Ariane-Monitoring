...
CREATE TABLE `servers` (
  ...
  `reboot_alert` int(11) NOT NULL DEFAULT '1',
  `offline_alert` int(11) NOT NULL DEFAULT '1',
  `offline_alert_send` int(11) DEFAULT NULL
) ENGINE=InnoDB DEFAULT CHARSET=latin1;
...
CREATE TABLE `servers_data` (
  ...
  `server_rx` bigint(20) NOT NULL,
  `server_rx_diff` bigint(20) NOT NULL,
  `server_tx_diff` bigint(20) NOT NULL,
